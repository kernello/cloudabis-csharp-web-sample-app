                    ...
                    <td class="auto-style3">
                        <fieldset style="width: 350px;">
                            ...
                            <table cellpadding="3px" cellspacing="0">
                                ...
                                <tr>
                                    <td class="auto-style1">Update ID
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtUpdateID" Width="276px" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnSubmit" runat="server" Text="Update" Enabled="true" OnClick="btnUpdate_Click" Height="40px" Width="155px" />
                                    </td>
                                </tr>
                                <tr>
